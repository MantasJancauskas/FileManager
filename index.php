...
print('<h2 class="logoutText">Eureka! You are logged in.<a href="logout.php" style="color:black;">Press me</a> to Logout.</h2>');
print('<br>');

//Greeter with user name
isset($_SESSION['UserData']['Username']) and ($_SESSION['UserData']['Username'] == true)
        ? print '<div class="main"><header><div class="container"><h3 style="color:black; text-align:center;"> Welcome, ' . $_SESSION['UserData']['Username'] . '!</h3>'
        : null;


print('<br>');

print('<h1 style="color:black; text-align:center;"> This is your File Browser</h1>');
